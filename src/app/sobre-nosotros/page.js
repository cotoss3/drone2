export const metadata = {
  title: 'Sobre Nosotros | AERO PANAMÁ',
...
export default function About() {
  return (
    <div className="section-padding container" style={{marginTop: '4rem', minHeight: '100vh'}}>
      <h1 style={{fontSize: '3rem', marginBottom: '1rem'}}>Sobre Aero Panamá</h1>
      ...
      <div className="glass-panel" style={{padding: '3rem', borderRadius: '4px', marginBottom: '3rem'}}>
        ...
        <p style={{color: 'var(--text-secondary)', lineHeight: '1.8', marginBottom: '1rem'}}>Fundada por pilotos certificados y cineastas, Aero Panamá nació con la misión de proporcionar calidad cinematográfica al sector corporativo e industrial. No somos vendedores de drones; somos expertos en captura de imagen aérea y soluciones visuales.</p>
      </div>
